...
![Pod vs Host Network](/img/pod-vs-host-network-qps.png)

Latency comparison:

![Pod vs Host Network](/img/pod-vs-host-network-latency.png)
...
![COS vs Ubuntu](/img/cos-vs-ubuntu-qps.png)

Latency comparison:

![COS vs Ubuntu](/img/cos-vs-ubuntu-latency.png)
...
![Service vs Load Balancer](/img/service-vs-load-balancer-qps.png)

Latency comparison:

![Service vs Load Balancer](/img/service-vs-load-balancer-latency.png)
...
![n1-standard-16 vs c2-standard-16](/img/n1-standard-16-vs-c2-standard-16-qps.png)

Latency comparison:

![n1-standard-16 vs c2-standard-16](/img/n1-standard-16-vs-c2-standard-16-latency.png)
...
![OLTP Update Index](/img/oltp-update-index-qps.png)
![OLTP Update Index](/img/oltp-update-index-latency.png)
...
![OLTP Update No Index](/img/oltp-update-no-index-qps.png)
![OLTP Update No Index](/img/oltp-update-no-index-latency.png)
...
![OLTP Read Write](/img/oltp-read-write-qps.png)
![OLTP Read Write](/img/oltp-read-write-latency.png)
...
![Single Zonal vs Regional](/img/single-zonal-vs-regional-qps.png)

Latency comparison:

![Single Zonal vs Regional](/img/single-zonal-vs-regional-latency.png)
